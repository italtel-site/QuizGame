...
struct SubjectsList: View {
  ...
  var subjects = [SingleSubject(index: "1",icon: "globe",SBJtext: "UFS01"),SingleSubject(index: "2",icon: "globe",SBJtext: "UFS02"),SingleSubject(index: "3",icon: "globe",SBJtext: "UFS03"),SingleSubject(index: "4",icon: "globe",SBJtext: "UFS04"),SingleSubject(index: "5",icon: "globe",SBJtext: "UFS05"),SingleSubject(index: "6",icon: "globe",SBJtext: "UFS06"),SingleSubject(index: "7",icon: "globe",SBJtext: "UFS07"),SingleSubject(index: "8",icon: "globe",SBJtext: "UFS08"),SingleSubject(index: "9",icon: "globe",SBJtext: "UFS09"),SingleSubject(index: "10",icon: "globe",SBJtext: "UFS10"),SingleSubject(index: "11",icon: "globe",SBJtext: "UFS01")]
